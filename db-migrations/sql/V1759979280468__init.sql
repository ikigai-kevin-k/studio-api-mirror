...
ALTER TABLE ONLY public.studio_cdn
    ADD CONSTRAINT pk_studio_cdn_id PRIMARY KEY ("ID");
ALTER TABLE ONLY public.studio_device
    ADD CONSTRAINT pk_studio_device_id PRIMARY KEY ("ID");
ALTER TABLE ONLY public.studio_error_signal_log
    ADD CONSTRAINT pk_studio_error_signal_log_id PRIMARY KEY ("ID");
ALTER TABLE ONLY public.studio_status
    ADD CONSTRAINT pk_studio_status_id PRIMARY KEY ("ID");
