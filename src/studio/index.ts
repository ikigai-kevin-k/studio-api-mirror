...
import { StudioGameRepository } from './repositories/studio-game/studio-game.repository';
...
export const StudioModule: ModuleProfile[] = [
  ...
  [InjectionTokensEnum.STUDIO_GAME_REPOSITORY, StudioGameRepository],
  [InjectionTokensEnum.STUDIO_GAME_SERVICE, StudioGameService],
  [InjectionTokensEnum.STUDIO_GAME_CONTROLLER, StudioGameController],
