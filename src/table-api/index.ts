...
import { TableApiForwardService } from './services/table-api-forward/table-api-forward.service';
...
export const TableApiModule: ModuleProfile[] = [
  ...
  [InjectionTokensEnum.TABLE_API_FORWARD_SERVICE, TableApiForwardService],
] as const;
